...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def __init__(self):
    ...
    print("==========Print robot current position")
  ...
  def move_joint_to_joint(self, joint_goal):
    move_group = self.move_group
...
def main():
  try:   
    ...
    raw_input
    home_goal = [pi, 0, pi/2, 0, pi/2, 0]
    tutorial.move_joint_to_joint(home_goal)

    print ("============ Press `Enter` to move to a second joint state goal ...")
    raw_input()
