...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ui_for_debug_and_demo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/giacomo/git_workspace/src/tmr_ros1/ui_for_debug_and_demo/${idir}'.  ${_report}")
    endif()
